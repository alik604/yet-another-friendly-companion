...
class MuZeroConfig:
    def __init__(self):
        ...
        self.batch_size = 64 # 64  # Number of parts of games to train on at each training step
        ...
        self.lr_init = 0.020  # 0.02 #0.005 # Initial learning rate
        self.lr_decay_rate = 0.5 #1  # Set it to 1 to use a constant learning rate
